...
public class BooleanRequest extends Request<Boolean> {
    ...
    public BooleanRequest(int method, String url, String requestBody, Response.Listener<Boolean> listener, Response.ErrorListener errorListener, Map<String, String> headers) {
