...
public class AvailableOrderAdapter extends RecyclerView.Adapter<AvailableOrderAdapter.MyViewHolder> {
    Context context;
    ArrayList<AvailableOrderModel> availableOrderModelArrayList;
    public AvailableOrderAdapter(Context context,ArrayList<AvailableOrderModel> availableOrderModelArrayList) {
    this.context=context;
    this.availableOrderModelArrayList=availableOrderModelArrayList;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.available_order_main, parent, false);
        return new AvailableOrderAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        AvailableOrderModel avo=availableOrderModelArrayList.get(position);
        String assign_date=avo.getOrderDate();
        Log.e("date_order",avo.getCustomer());
        JSONObject jsonObject_customer = null;
        try {
            jsonObject_customer = new JSONObject(avo.getCustomer());
            ...
            holder.customer.setText(firstName_cust+"");
        ...
        holder.delivery_type.setText(avo.getDeliveryType());

        holder.view_order.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, OrderDetailActivity.class);
                intent.putExtra("available_orderData",avo);
    ...
    public int getItemCount() {
        return availableOrderModelArrayList.size();
    }

    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView delivery_type,date,customer,view_order;
